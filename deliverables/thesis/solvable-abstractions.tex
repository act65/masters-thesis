...
\begin{displayquote}
\textit{What should we make of the form of the optimal control?}
\end{displayquote}
...
\begin{displayquote}
\textit{What should we make of the form of the value estimate?}
\end{displayquote}
...
\begin{displayquote}
\textit{So, LMDPs can be easily solved. But how does solving a LMDP help us solve a MDP?}
\end{displayquote}
...
For a derivation and explanation see appendix \ref{mdp-Linearisation}.
