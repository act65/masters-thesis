...
\footnotetext{In general, when we state abstractions, we mean abstractions for reinforcement learning.}
...
\begin{itemize}
  \tightlist
  % \item CSurveyonstruct a family of similarity measures for building abstractions for RL.
