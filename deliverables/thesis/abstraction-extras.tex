...
\begin{itemize}
	\tightlist
	\item the expected return is invaraint to
	\item the Bellman residual is invariants to ...
	\item the reachable rewards are invariant to flips around the mirror plane
\end{itemize}
There is also an equivariant quantity, the change in state (assuming the respresentation of the state is equal to ...)
...
{\color{red}TODO verify these invaraints!?!?}

Is this combination of invariants unque to the mirror symmetry? (how to prove this?!)
...
{\color{red} this one seems hard. not sure i am gonig to be able to explicitly construct this one?!}
