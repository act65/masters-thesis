...
% Just because the abstraction can efficiently solve a problem ...
% We care about the complexity of abstracting, solving and lifting.
% So we can actually apply the abstraction to a problem of interest.
...
\footnotetext[11]{To contruct this representation, we set the state to be centered around the mirror plane.
...
\footnotetext[8]{This notion can be generalised to state-actions, or options by doing !?!? or ref.}
...
% want more formal version of these arguments!?
