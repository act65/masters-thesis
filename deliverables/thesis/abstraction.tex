...
\footnotetext[26]{However, this argument does not take into account how the topology of the $Q$ values may have changed.}
...
\footnotetext[29]{This is is closely related to the notion of a general value function \cite{White2015}}
...
\vspace{5mm}
\footnotetext[27]{This statement assumes we have encoded the states as onehots. Also, it does not seem so obvious that it doesn't need proof.}
