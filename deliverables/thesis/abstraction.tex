...
\end{enumerate}
% How does on/off policy come into this!?

% This is an attempt to organise similarity measures for abstractions for RL.
...
!!We have families of similarity for building abstractions. But we need a way to analyse them and pick the best ones....
