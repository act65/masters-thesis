...
Specifically, we consider a type of linear abstraction, and give a negaive result.
We then explore a type of symmetric abstraction and show an improvement in sample efficiency. 
}
