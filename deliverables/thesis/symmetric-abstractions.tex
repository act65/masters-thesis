...
\end{displayquote}
 ...
 % Given uncertainty, we prefer symmetry.
...
\subsubsection{More or less symmetric?}
...
Therefore, these can be identified using only representations of $S_2$.

% BUT. $S_2$ has no interesting group structure. We cant use closure to infer other similarities!??!
% We can only push things towards being in $S_2$
