...
For example, we can imagine the \textit{action}\footnotemark of this rotation group $\big(0, 90, 180, 270, \circ \big)$ on a playing card. (bad example!?)
...
Less cryptically, Thomspon sampling estimates the model, $P\, r$. We then act optimally with respect to the estimated model. However, the estimate uncertainty, so ...? We can write this as follows.
