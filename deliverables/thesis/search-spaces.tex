...
\tightlist
  ...
  \item How do the dynamics of GPI partition the policy / value spaces?
\end{itemize}
...
and a way to evaluate these potential solutions, a cost or loss function. For example, we {\color{red}example..!??!}
